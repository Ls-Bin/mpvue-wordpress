...
exports.cssLoaders = function (options) {
  ...
  var sassResourceLoader = {
    ...
    options: {
      resources: [
      //修改相应路径
        path.resolve(__dirname, '../src/assets/scss/core/_variables.scss'),
        path.resolve(__dirname, '../src/assets/scss/core/_media-queries.scss'),
        path.resolve(__dirname, '../src/assets/scss/core/_mixin.scss'),
        // path.resolve(__dirname,  '../src/assets/scss/core/_animation.scss'),
        // path.resolve(__dirname,  '../src/assets/scss/core/_reset.scss'),
        // path.resolve(__dirname,  '../src/assets/scss/ext/_grid.scss'),
        path.resolve(__dirname,  '../src/assets/scss/ext/_base.scss')
      ]
    }
  }
